...
def salvar
  ...
  def atributos
   ...
   @atributos_lotacao = ["funcionario_id", "escola_id", "carga_horaria_disponivel", "data_lotacao", "regencia_de_classe", "created_at", "updated_at", "finalizada", "codigo_barra", "ativo", "tipo_lotacao", "orgao_id", "esfera_id", "tipo_destino_id", "departamento_id", "unidade_id", "convalidada", "data_convalidacao", "convalidador_id", "entidade_id", "complementar", "ambiente_id", "data_confirmacao", "quick", "motivo", "usuario_id", "disciplina_atuacao_id", "destino_id", "destino_type", "state", "contrato_id","natureza"]
 end
